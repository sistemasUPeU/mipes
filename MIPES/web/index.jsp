<%-- 
    Document   : index
    Created on : 16/05/2016, 07:20:08 PM
    Author     : Andres
--%>
                                ...
                                <ul class="nav side-menu">
                                    <li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu" style="display: none">
                                            ...
                                            <li><a href="vista/index3.html">Dashboard3</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li><a><i class="fa fa-edit"></i> Forms <span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu" style="display: none">
                                            <li><a href="vista/form.html">General Form</a>
                                            </li>
                                            <li><a href="vista/form_advanced.html">Advanced Components</a>
                                            </li>
                                            <li><a href="vista/form_validation.html">Form Validation</a>
                                            </li>
                                            <li><a href="vista/form_wizards.html">Form Wizard</a>
                                            </li>
                                            <li><a href="vista/form_upload.html">Form Upload</a>
                                            </li>
                                            <li><a href="vista/form_buttons.html">Form Buttons</a>
                                            </li>
                                        </ul>
                                    </li>
                                ...
                                <ul class="nav side-menu">
                                    <li><a><i class="fa fa-bug"></i> Additional Pages <span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu" style="display: none">
                                            ...
                                            <li><a href="vista/projects.html">Projects</a>
                                            </li>
                                            <li><a href="vista/project_detail.html">Project Detail</a>
                                            </li>
                                            <li><a href="vista/contacts.html">Contacts</a>
                                            </li>
                                            <li><a href="vista/profile.html">Profile</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li><a><i class="fa fa-windows"></i> Extras <span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu" style="display: none">
                                            ...
                                            <li><a href="vista/page_500.html">500 Error</a>
                                            </li>
                                            <li><a href="vista/plain_page.html">Plain Page</a>
                                            </li>
                                    ...
                                    <li><a><i class="fa fa-sitemap"></i> Multilevel Menu <span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu" style="display: none">
                                            ...
                                            <li><a>Level One<span class="fa fa-chevron-down"></span></a>
                                                <ul class="nav child_menu" style="display: none">
                                                    <li class="sub_menu"><a href="vista/level2.html">Level Two</a>
                                                    </li>
