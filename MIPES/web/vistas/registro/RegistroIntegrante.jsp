                ...
                <div class="panel-body">
                    <form class="form-horizontal">
                        <div class="col col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <label>Nombres</label>
                            <input type="text" class="form-control" placeholder="Nombres del nuevo Integrante">
                        </div>
                        <div class="col col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <label>Apellidos</label>
                            <input type="text" class="form-control" placeholder="Apellidos del nuevo Integrante">
                        </div>
                        <div class="col col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <label>Direccion</label>
                            <input type="text" class="form-control" placeholder="Direccion del nuevo Integrante">
                        </div>
                        <div class="col col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <label>E-mail</label>
                            <input type="email" class="form-control" placeholder="E-mail del nuevo Integrante">
                        </div>
                        <div class="col col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <label>Teléfono</label>
                            <input type="tel" class="form-control" placeholder="Teléfono del nuevo Integrante">
                        </div>
                        <div class="col col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <label>DNI</label>
                            <input type="number" class="form-control" placeholder="DNI del nuevo Integrante">
                        </div>
                        <div class="col col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <label>Fecha de Nacimiento</label>
                            <input type="date" class="form-control" placeholder="Fecha de Nacimiento del nuevo Integrante">
                        </div>
                        <div class="col col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <label>Fecha de Bautizmo</label>
                            <input type="date" class="form-control" placeholder="Fecha de Bautizmo del nuevo Integrante">
                        </div>
                        <div class="col col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <label>Género</label>
                        ...
                        <div class="col col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            ...
                            <input type="text" class="form-control" placeholder="Si es estudiante o docente, especificar Carrera Profesional">
                        </div>
                        <div class="col col-lg-6 col-md-6 col-sm-12 col-xs-12 pull-right">
                            <button class="btn btn-primary pull-right btn-block">Registrar</button> 
                        </div>
                    </form>
                </div>
            </div>
