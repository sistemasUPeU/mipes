...
<%
    ...
    String rol = "";
    if (MainControl.validateRol("10", session) || MainControl.validateRol("5", session) || MainControl.validateRol("6", session) || MainControl.validateRol("7", session)) {
        enable = true;
    ...
    <center>
        <div style="width: 90%;">
            ...
            <div id="contButtons">
                ...
                <button onclick="modEscuela(this.value)" value="<%=rol%>" class="btn btn-warning hidden bescuela" type="button" data-toggle="modal" data-target=".bs-example-modal-lg"><i class="fa fa-book"></i>   Ver por Escuela Sabática</button>
                <button onclick="modGrupo(this.value)" value="<%=rol%>" class="btn btn-danger bgrupo" type="button" data-toggle="modal" data-target=".bs-example-modal-lg"><i class="fa fa-users"></i>   Ver por Grupo Pequeño</button>
            </div>
        </div>
        ...
        <script src="vistas/reportesgp/opdetalle.js"></script>
