<%-- 
    Document   : repasisGPIG
    Created on : 05/08/2016, 10:40:06 AM
    Author     : Leandro
--%>
...
<html>
    ...
    <center>
        <div class="row x_title" style="padding: 1% 10%;box-sizing: border-box;">
            <div class="col-md-6">
                <h3 id="titulo">Reporte de Asistencia de los G.P. de la Iglesia </h3>
            </div>
    ...
    <script src="vistas/reportesgp/opgpig.js"></script>
</body>
</html>
